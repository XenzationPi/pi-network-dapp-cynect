      ...
      <CardHeader>
        ...
        {userRewards && (
          <div className="flex items-center justify-center space-x-2 mt-4 animate-scale-up">
            <Coins className="w-5 h-5 text-cyan-400 dark:text-cyan-300" />
        ...
        <CardDescription className="text-center mt-2 text-sm text-gray-400 dark:text-gray-300 animate-fade-in">
